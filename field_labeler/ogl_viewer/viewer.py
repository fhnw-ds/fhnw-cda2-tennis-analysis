...
class GLViewer:
    ...
    def update_view(self, _image, _pose, _tracking_state):     
        ...
        copy = {
            'hit': self.user_action.hit,
            'hit_coord': self.user_action.hit_coord,
            'press_space': self.user_action.press_space
        }
        ...
        if self.available:
            ...
            if self.use_imu:
                ...
                for plane_type in sl.PLANE_TYPE:
                    if plane_type != sl.PLANE_TYPE.LAST and plane_type != sl.PLANE_TYPE.VERTICAL:
